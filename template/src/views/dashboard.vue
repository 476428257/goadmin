        ...
        <el-row :gutter="20" class="mgb20">
            <el-col :span="6">
                <el-card shadow="hover" body-class="card-body">
                    ...
                    <div class="card-content">
                        <countup class="card-num color1" :end="data.n1" />
                        <div>用户访问量</div>
                    </div>
                </el-card>
            </el-col>
            <el-col :span="6">
                <el-card shadow="hover" body-class="card-body">
                    ...
                    <div class="card-content">
                        <countup class="card-num color2" :end="data.n2" />
                        <div>系统消息</div>
                    </div>
                </el-card>
            </el-col>
            <el-col :span="6">
                <el-card shadow="hover" body-class="card-body">
                    ...
                    <div class="card-content">
                        <countup class="card-num color3" :end="data.n3" />
                        <div>商品数量</div>
                    </div>
                </el-card>
            </el-col>
            <el-col :span="6">
                <el-card shadow="hover" body-class="card-body">
                    ...
                    <div class="card-content">
                        <countup class="card-num color4" :end="data.n4" />
                        <div>今日订单量</div>
                    </div>
                </el-card>
            </el-col>
...
const data =reactive({n1:0,n2:0,n3:0,n4:0})
const getData = async () => {
    NProgress.start();
    try {
        const res = await service.post('/api/api/v1/system/dashboard');
        if (res.data.code === 200) {
            data.n1=res.data.data.n1
            data.n2=res.data.data.n2
            data.n3=res.data.data.n3
            data.n4=res.data.data.n4
        }else{
